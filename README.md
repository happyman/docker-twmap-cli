...
./twmap.sh
Usage: /twmap/twmap_gen/cmd_make2.php -r 236:2514:6:4:TWD67 [-g gpx:0:0] [-c] [-G] -O dir [-e] -v 1|3|2016 -t title [-i localhost] [-m /tmp]
       ...
       -3 for A3 output
       -l uniqid to notify web interface
       -a callback url for backend
       -m /tmp tmpdir
